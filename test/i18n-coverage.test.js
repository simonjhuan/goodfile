...
const MUST_TRANSLATE = [
  ...
  'ส่งไฟล์ ง่ายๆ',
  'เร็ว เป็นส่วนตัว ส่งตรงระหว่างเครื่อง',
  'เลือกไฟล์',
  'รูป วิดีโอ เอกสาร โฟลเดอร์',
  'ส่งไฟล์',
  'เลือกรูป วิดีโอ หรือเอกสาร',
  '↓ รับไฟล์จากอีกเครื่อง',
  'ไม่ลดคุณภาพ',
  'รับไฟล์ใน 3 ขั้นตอน',
  'ให้อีกเครื่องต่อ Wi-Fi เดียวกัน',
  'สแกน QR ที่เห็นด้านบน',
  'กดดาวน์โหลด รับไฟล์ได้ทันที ✓',
  // PC browser -> Android, four-digit pairing
  'PC เปิด gf.maew0009.workers.dev',
  'กำลังสร้างรหัส 4 ตัว...',
  'สร้างรหัสใหม่',
  'หรือใช้ QR ใน Wi-Fi เดียวกัน',
  'กำลังเปิดเครื่องรับไฟล์...',
  'PC กรอกรหัสนี้ แล้วเลือกไฟล์',
  'ใช้ได้ 5 นาที · ลองซ้ำได้',
  'รหัสหมดอายุแล้ว — กดสร้างรหัสใหม่',
  'PC เชื่อมต่อแล้ว — รอเลือกและส่งไฟล์',
  'เชื่อมตรงผ่าน Wi-Fi เดียวกัน',
  'สร้างรหัสออนไลน์ไม่ได้ — ใช้ QR หรือ URL ด้านล่าง',
  'ตรวจอินเทอร์เน็ตแล้วลองใหม่',
  'รับไฟล์สำเร็จ',
  'กดสร้างรหัสใหม่เพื่อรับไฟล์ถัดไป',
  'รหัส 4 ตัวรองรับ Android เท่านั้น',
  'ฟีเจอร์นี้ใช้ได้เฉพาะแอป Android',
  'เปิดพอร์ตรับไฟล์ไม่ได้',
  'ตรวจตามนี้ แล้วลองสแกน QR ล่าสุดอีกครั้ง',
  '1. ตรวจว่า Wi-Fi บนทั้งสองเครื่องเป็นชื่อเดียวกัน',
  '2. ปิด VPN ชั่วคราว แล้วลองอีกครั้ง',
  '3. ถ้ายังไม่ได้ ลองใช้ Hotspot จากเครื่องหนึ่ง',
  'ให้อีกเครื่องเชื่อมต่อ Hotspot แล้วสแกนใหม่',
  'หรือส่งข้อความแทน',
  'ไม่ผ่านคลาวด์',
  'ไม่จำกัดขนาด',
  'ส่วนตัว',
  ...
  'ภาษา',
  'โหมดสว่าง',
  'สลับพื้นหลังสว่าง/มืด',
  'ส่งทั้งโฟลเดอร์',
  'รวมเป็นไฟล์ zip ก่อนส่ง',
  'รายงานปัญหา',
  'ส่งบันทึกในเครื่องให้ผู้พัฒนา',
];
