...
const checks = [
  ...
  ['Android uses its banner unit', read('www/index.html').includes('ca-app-pub-5804107706055854/2902211067')],
  ['iOS uses its banner unit', read('www/index.html').includes('ca-app-pub-5804107706055854/6840571593')],
